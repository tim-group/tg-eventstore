...
public final class DiffForkApp {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        EventSource eventSourceReadMany = BasicMysqlEventSource.pooledReadOnlyDbEventSource(properties, dbKeyArg, dbTableArg, dbKeyArg + "->" + dbTableArg, 50000, new MetricRegistry());
        EventSource eventSourceReadOne = BasicMysqlEventSource.pooledReadOnlyDbEventSource(properties, dbKeyArg, dbTableArg, dbKeyArg + "->" + dbTableArg + "(batchSize 1)", 1, new MetricRegistry());
